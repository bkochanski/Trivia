...
#url <- "https://gist.githubusercontent.com/BERENZ/c8f1ca3947b3454e7ea85548a3ac4c8c/raw/be4e08bc35e55d4439f96d8411f16ddeb65197a3/ELECTIONS-LOCAL-DEMOGRAPHIC-FREQUENCY.json"
url <- "https://gist.githubusercontent.com/BERENZ/933ace18d4a20f1f04bd104308147060/raw/fd557920ea361a4d0bca153ccb367cefd7093cd1/ELECTIONS-LOCAL-DEMOGRAPHIC-FREQUENCY.json"
response <- GET(url)
...
ggplot(df, aes(x = Age_Group, y = Percentage)) +
  ...
  geom_text(aes(label = sub("\\.", ",", sprintf("%.1f", Percentage))),
            vjust = -0.3, size = 3) + 
...
#  coord_cartesian(ylim = c(0, 48)) +
  ...
  labs(caption = "Źródło danych: Late poll (50%) https://www.tvp.info/wybory-prezydenckie-2025 via https://gist.github.com/BERENZ")
